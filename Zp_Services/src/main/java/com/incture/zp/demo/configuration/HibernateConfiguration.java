...
@ComponentScan({ "com.incture.zp.demo.configuration" })
...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.incture.zp.demo" });
...
/*	@Bean
	public RestInvoker getRestInvoker() {
		String url = environment.getRequiredProperty("hci.baseURL");
